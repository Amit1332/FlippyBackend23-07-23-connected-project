...
exports.updateAllSellerdetails = catchAsyncError(async (req, res, next) => {
...
exports.updateSellerBankdetails = catchAsyncError(async (req, res, next) => {
  const updatesellerdata= {
    bank_details:{
      account_number:req.body.account_number,
      ifsc_code:req.body.ifsc_code
...
exports.updateSellerAddressdetails = catchAsyncError(async (req, res, next) => {
  const updatesellerdata= {
    pickup_address:{
      house_no:req.body.house_no, 
      street:req.body.street,
...
// update  seller supplier shop details
exports.updateSellerShopdetails = catchAsyncError(async (req, res, next) => {
  const updatesellerdata= {
    supplier_details:{
      store_name:req.body.store_name,
      your_name:req.body.your_name
